...
'
  'Landmark Detector' 'waitForRos; rosrun body_movement_swarming LandmarkDetector.py
'
  'Static Gestures' 'waitForRos; rosrun body_movement_swarming StaticGestures
'
  'Classifier Gesture' 'waitForRos; rosrun body_movement_swarming ClassifierGesture
'
  'Gesture Controller' 'waitForRos; rosrun body_movement_swarming GestureController
'
